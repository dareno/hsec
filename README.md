...
SSLFILE="hsec"
openssl genrsa -out ${SSLFILE}.key 1024
openssl req -subj "/C=US/ST=Pennsylvania/L=West Chester/O=Security/CN=renos.asuscomm.com" -new -key ${SSLFILE}.key -out ${SSLFILE}.csr
