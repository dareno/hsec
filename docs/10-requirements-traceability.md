...
| [FR7](02-product-requirements.md#fr7-sensor-data-processing)       | `hardware/mcp23017.py`; `services/sensor_deserializer.py`; Sensor Monitor (planned) | [§FR7](02-product-requirements.md#fr7-sensor-data-processing) | `hardware/mcp23017.py`; `services/sensor_deserializer.py`; `tests/unit/test_sensor_deserializer.py` |
